...
export function Dropdown() {
  ...
  const toggle = () => setCollapseStatus(!collapseStatus);
  return (
    ...
    //     <div className="flex m-3.5" onClick = {toggle}>
    //         <div className="flex-1 h-16 ">
    //             <img className="h-9 w-9" src={logoUrl} alt="Workflow" />
    //         </div>
    //         <div className="flex-shrink-0 h-16 w-32">
    //             <p className = "text-xs">Fieonix Interest Account</p>
    ...
    //         </div>
    //     </div>
    //     <hr className = "text-hrColor-hr-col" />
    //     </Collapse>
    // </div>
  )
}